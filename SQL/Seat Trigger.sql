CREATE OR REPLACE FUNCTION handle_seat_removal(seat_id_input INT) RETURNS VOID AS $$
...
AFTER DELETE ON seats FOR EACH ROW EXECUTE FUNCTION handle_seat_removal(OLD.seat_id);